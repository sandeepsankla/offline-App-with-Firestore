...
public abstract class Hilt_AddUserDetailFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddUserDetailFragment() {
    super();
  }

  Hilt_AddUserDetailFragment(int arg0) {
    super(arg0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddUserDetailFragment_GeneratedInjector) this.generatedComponent()).injectAddUserDetailFragment(UnsafeCasts.<AddUserDetailFragment>unsafeCast(this));
    }
  }
